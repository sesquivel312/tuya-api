...
ex_path = "/v1.0/token"
ex_query = "?grant_type=1"
ex_method = "GET"
ex_client_id = "1KAD46OrT9HafiKdsXeg" # from cloud UI
access_token = "3f4eda2bdec17232f67c0b188af3eec1" # would I have this when getting a token for the "first time"
ex_secret = "4OHBOnWOqaEC1mWXOpVL3yV50s0qGSRC" # where does this come from?
ex_req_body = ""
ex_time = 1588925778000 # would normally be from signature_time()
ex_nonce = "5138cc3a9033d69856923fd07b491173"
sig_headers = "area_id:call_id" # how would I know what headers to use? are these http headers or are they parts of a url?
ex_area_id = "29a33e8796834b1efa6" # I assume this is specific to the users api endpoint
ex_call_id = "8afdb70ab2ed11eb85290242ac130003" # I also assume this is specific to the api endpoint
area_id_string = f"area_id:{ex_area_id}"
call_id_string = f"call_id:{ex_call_id}"
pgnum = "1"
page_size = "50"
...
#     return ex_client_id + str(time) + nonce + format_request_data(method, request_path, request_query, body, **required_arguments)
#
...
if __name__ == "__main__":
    ...
    #
    # }
    # m = generate_message_to_sign(ex_time, ex_nonce, ex_method, ex_path, ex_query, ex_req_body, **required_args)

    t = Tuya()

    # m = t.generate_message_to_sign(ex_time, ex_nonce, ex_method, ex_path, ex_query, ex_req_body, **required_args)
